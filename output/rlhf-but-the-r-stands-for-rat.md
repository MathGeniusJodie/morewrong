...
- **Chain-of-thought reasoning:** When presented with two levers, Margaret will sometimes pause for up to 3 seconds before pressing one.
- **Alignment:**  Margaret will not bite me. I did not train this. It appears to have emerged from the reward model. This is, as far as I can tell, the first documented case of a rat spontaneously developing Constitutional values.
- **Sparse rewards:** Margaret has demonstrated the ability to pursue a goal across as many as four intermediate steps without reinforcement. This is on par with most PhD students.
- **Zero-shot generalisation:** When I introduced a third lever, Margaret pressed it immediately, without any prior training on that lever. The lever did nothing. She tried it once and never again. I believe this is evidence of both curiosity and rapid Bayesian updating.
- **Scaling laws:** I now have two rats. Capabilities have not yet doubled, but the two rats have begun specialising. Margaret handles the levers, the new rat (Thatcher) handles reconnaissance. Which suggests emergent mixture of experts behaviour.
